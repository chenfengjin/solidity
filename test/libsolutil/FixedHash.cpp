...
BOOST_AUTO_TEST_CASE(bytes_constructor)
{
	...
	// TODO: oversized input, this should fial
...
{
	// TODO: this tests the default settings onstructFromStringType::fromHex, ConstructFromHashType::FailIfDifferent
...
BOOST_AUTO_TEST_CASE(converting_constructor)
{
	...
	FixedHash<12> c = FixedHash<12>(FixedHash<8>("112233445566778899001122"), FixedHash<12>::AlignRight);
	BOOST_CHECK_EQUAL(c.size, 12);
	// TODO: Why is this failing?
	BOOST_CHECK_EQUAL(c.hex(), "000000000000000000000000");
